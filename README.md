This is a repo, where kafka is implemented as asynchronous communication between different applications (node js). Please have a look at blog, for better understanding and setup .
